...
- 피킹 플랜에서 보조운동 deficit-fill 강도를 phase별로 단계 감소(축적 1.0→강화 0.5→피크 0.0)하고 피크 주 보조 개수를 1개 절감. 방향은 블록 주기화 컨센서스(Issurin 2010; Mujika &amp; Padilla 2003)이나 정확 승수·감축폭·phase 임계는 휴리스틱(`근거 약함`). floor=minCap으로 피크 주에도 보조가 0이 되지 않음; 비대회 플랜 bit-for-bit 보존
