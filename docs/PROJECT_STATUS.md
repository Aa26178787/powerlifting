...
- 보조운동 근육 타깃팅 강도는 휴리스틱(consensus 외삽): 파워빌딩은 미달 근육군 deficit-fill 활성(PL은 SBD 특이성 보호로 0). 방향 근거(부하 무관 근비대, 수확체감 — Pelland/Zourdos 2026; Schoenfeld 2017); 정확 계수(full 0.6 / 활성 시작 hyp점유율 0.30 / 포화 0.50)와 MEV/MAV/MRV 밴드, 보조 개수는 컨센서스·추정치이며 직접 임상 임계 아님
